...
static const uint8_t STATE_RUN = 0b0000'0010;             // _r_un
static const uint8_t STATE_STOP = 0b1111'1101;            // _s_top, so state &= STATE_STOP unsets run bit
static const uint8_t STATE_PAUSE = 0b0000'0100;           // _p_ause
static const uint8_t STATE_CLEAR = 0b0000'1000;           // _c_lear
static const uint8_t STATE_INC = 0b0001'0000;             // _+_: increase speed of simulation
static const uint8_t STATE_DEC = 0b0010'0000;             // _-_: decrease speed of simulation
static const uint8_t STATE_GRID = 0b0100'0000;            // _g_rid toggle
static const uint8_t STATE_DONE = 0b1000'0000;            // generation is complete
...
typedef struct _ctx
{
  ...
  uint32_t           cnt;             // number of points to generate
